...
public class News extends BaseObject implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2678343063753354570L;
	...
	@Column(name="f_content", length=2000, nullable=false)
	...
	public String toString() {
		return "News [" + (id != null ? "id=" + id + ", " : "") + (title != null ? "title=" + title + ", " : "")
