...
public class DashboardStudentAttendanceController {
	...
	public String attendanceView(Model model,
		...
		return attendanceView(cal.get(Calendar.MONTH), cal.get(Calendar.YEAR), model, reat, principal);
	}
	
	@GetMapping("/{currentMonth}/{currentYear}")
	public String attendanceView(@PathVariable Integer currentMonth, 
